...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.root_dir = 'D:\\osstem_pano_data\\'
        self.raw_data_dir = '{}rawdata\\anonymous\\'.format(self.root_dir)        
        ...
        '''
        self.pp_name = 'pp_norm_pa_real_new'
        self.input_df_name = 'info_df.pickle'
        #self.pp_data_path = '/path/to/preprocessed/data/{}'.format(self.pp_name)
        self.pp_data_path = '{}{}\\'.format(self.pp_dir, self.pp_name)
        self.pp_test_data_name = ''
        self.pp_test_data_path = '{}pp_norm_real_new_big\\'.format(self.pp_dir)        
        ...
        self.batch_size = 16 if self.dim == 2 else 1
    ...
    def add_det_unet_configs(self):
        ...
        self.n_roi_candidates = 10 if self.dim == 2 else 40
    ...
    def add_mrcnn_configs(self):
        ...
        #self.backbone_strides = {'xy': [2, 4, 8, 16], 'z': [2, 4, 8, 16]}
        ...
        self.rpn_anchor_scales = {'xy': [[16], [24], [32], [64]], 'z': [[16], [24], [32], [64]]}
        ...
        self.rpn_anchor_stride = 2

        # Threshold for first stage (RPN) non-maximum suppression (NMS):  LOWER == HARDER SELECTION
        self.rpn_nms_threshold = 0.7 if self.dim == 2 else 0.59

        # loss sampling settings.
        self.rpn_train_anchors_per_image = 64  #per batch element
        self.train_rois_per_image = 64 #per batch element
        ...
        self.pool_size = (7, 7) if self.dim == 2 else (5, 5, 5)
        self.mask_pool_size = (14, 14) if self.dim == 2 else (10, 10, 10)
        self.mask_shape = (28, 28) if self.dim == 2 else (20, 20, 20)
        ...
        self.roi_chunk_size = 3000
        self.post_nms_rois_training = 3000
        self.post_nms_rois_inference = 256

        # Final selection of detections (refine_detections)
        #self.model_max_instances_per_batch_element = 10 if self.dim == 2 else 300  # per batch element and class.
        self.model_max_instances_per_batch_element = 256  # per batch element and class.
        self.detection_nms_threshold = 0.5  # needs to be > 0, otherwise all predictions are one cluster.
        self.model_min_confidence = 0.3
